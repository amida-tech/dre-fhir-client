...
var _searchAll = function _searchAll(urlstring, currentCount, maxCount, callback) {
    request.get(urlstring, function (err, response, bundle) {
        if (err) {
            ...
            if (next && ((!maxCount) || (currentCount < maxCount))) {
                ...
                _searchAll(next.url, currentCount, maxCount, function (err, remaining) {
                    if (err) {
                        callback(err);
                    } else {
...
exports.searchAll = function searchAll(serverInfo, resourceType, parameters, maxCount, callback) {
    ...
    _searchAll(urlstring, 0, maxCount, callback);
};
